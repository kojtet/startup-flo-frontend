  ...
  const handleUpgrade = async () => {
    try {
      ...
      toast({
        title: "Success",
        description:
          "Plan upgrade initiated. You will be redirected to complete payment.",
      });
    } catch {
      toast({
        title: "Error",
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                ...
                <Progress
                  value={
                    (usageData.users.current / usageData.users.limit) * 100
                  }
                  className="h-2"
                />
              </div>
              <div className="space-y-2">
                ...
                <Progress
                  value={
                    (usageData.storage.current / usageData.storage.limit) * 100
                  }
                  className="h-2"
                />
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {usageData.api_calls.current.toLocaleString()} /{" "}
                    {usageData.api_calls.limit.toLocaleString()}
                  </span>
                </div>
                <Progress
                  value={
                    (usageData.api_calls.current /
                      usageData.api_calls.limit) *
                    100
                  }
                  className="h-2"
                />
